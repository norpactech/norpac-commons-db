-- ---------------------------------------------------------------------------------------
-- Insert: norpac_commons.tenant_user. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------

DROP FUNCTION IF EXISTS norpac_commons.i_tenant_user;
CREATE FUNCTION norpac_commons.i_tenant_user(
  IN p_id_tenant UUID, 
  IN p_id_user UUID
)
...
BEGIN
  ...
  INSERT INTO norpac_commons.tenant_user (
    id_tenant, 
    id_user
  )
  VALUES (
