-- ---------------------------------------------------------------------------------------
-- Insert: norpac_commons.product_category. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------

DROP FUNCTION IF EXISTS norpac_commons.i_product_category;
CREATE FUNCTION norpac_commons.i_product_category(
  IN p_id_tenant UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'i_product_category';
...
BEGIN
  ...
  INSERT INTO norpac_commons.product_category (
    id_tenant, 
    id_parent_category, 
    code, 
    name, 
  ...
  EXCEPTION
    WHEN UNIQUE_VIOLATION THEN
      v_response := (
        ...
        'A record already exists in the product_category table', 
