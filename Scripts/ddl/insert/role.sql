-- ---------------------------------------------------------------------------------------
-- Insert: norpac_commons.role. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------

DROP FUNCTION IF EXISTS norpac_commons.i_role;
CREATE FUNCTION norpac_commons.i_role(
  IN p_name VARCHAR, 
...
BEGIN
  ...
  INSERT INTO norpac_commons.role (
    name, 
    description, 
    created_by,
    updated_by
  ...
  EXCEPTION
    WHEN UNIQUE_VIOLATION THEN
      v_response := (
        ...
        'A record already exists in the role table', 
