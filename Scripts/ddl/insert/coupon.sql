-- ---------------------------------------------------------------------------------------
-- Insert: norpac_commons.coupon. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------

DROP FUNCTION IF EXISTS norpac_commons.i_coupon;
CREATE FUNCTION norpac_commons.i_coupon(
  IN p_id_tenant UUID, 
...
BEGIN
  ...
  INSERT INTO norpac_commons.coupon (
    id_tenant, 
    id_rt_coupon_type, 
    name, 
    code, 
  ...
  EXCEPTION
    WHEN UNIQUE_VIOLATION THEN
      v_response := (
        ...
        'A record already exists in the coupon table', 
