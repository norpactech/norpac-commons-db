-- ---------------------------------------------------------------------------------------
-- Insert: norpac_commons.billing_interval. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------

DROP FUNCTION IF EXISTS norpac_commons.i_billing_interval;
CREATE FUNCTION norpac_commons.i_billing_interval(
...
DECLARE
  ...
  c_service_name TEXT := 'i_billing_interval';
...
BEGIN
  ...
  INSERT INTO norpac_commons.billing_interval (
    id_rt_interval_unit, 
    name, 
    descritption, 
    interval_code, 
  ...
  EXCEPTION
    WHEN UNIQUE_VIOLATION THEN
      v_response := (
        ...
        'A record already exists in the billing_interval table', 
