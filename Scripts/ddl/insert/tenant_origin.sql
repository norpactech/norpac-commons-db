-- ---------------------------------------------------------------------------------------
-- Insert: norpac_commons.tenant_origin. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------

DROP FUNCTION IF EXISTS norpac_commons.i_tenant_origin;
CREATE FUNCTION norpac_commons.i_tenant_origin(
  IN p_name VARCHAR, 
...
DECLARE
  ...
  c_service_name TEXT := 'i_tenant_origin';
...
BEGIN
  ...
  INSERT INTO norpac_commons.tenant_origin (
    name, 
    description, 
    created_by,
    updated_by
  ...
  EXCEPTION
    WHEN UNIQUE_VIOLATION THEN
      v_response := (
        ...
        'A record already exists in the tenant_origin table', 
