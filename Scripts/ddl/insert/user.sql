-- ---------------------------------------------------------------------------------------
-- Insert: norpac_commons.user. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------

DROP FUNCTION IF EXISTS norpac_commons.i_user;
CREATE FUNCTION norpac_commons.i_user(
  IN p_email VARCHAR, 
...
BEGIN
  ...
  INSERT INTO norpac_commons.user (
    email, 
    last_name, 
    first_name, 
    created_by,
