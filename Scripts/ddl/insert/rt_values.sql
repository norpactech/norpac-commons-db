-- ---------------------------------------------------------------------------------------
-- Insert: norpac_commons.rt_values. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------

DROP FUNCTION IF EXISTS norpac_commons.i_rt_values;
CREATE FUNCTION norpac_commons.i_rt_values(
  IN p_id_tenant UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'i_rt_values';
...
BEGIN
  ...
  INSERT INTO norpac_commons.rt_values (
    id_tenant, 
    id_rt_type, 
    sequence, 
    name, 
  ...
  EXCEPTION
    WHEN UNIQUE_VIOLATION THEN
      v_response := (
        ...
        'A record already exists in the rt_values table', 
