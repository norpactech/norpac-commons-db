-- ---------------------------------------------------------------------------------------
-- Insert: norpac_commons.region. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------

DROP FUNCTION IF EXISTS norpac_commons.i_region;
CREATE FUNCTION norpac_commons.i_region(
  IN p_id_tenant UUID, 
...
BEGIN
  ...
  INSERT INTO norpac_commons.region (
    id_tenant, 
    id_rt_region_type, 
    name, 
    description, 
  ...
  EXCEPTION
    WHEN UNIQUE_VIOLATION THEN
      v_response := (
        ...
        'A record already exists in the region table', 
