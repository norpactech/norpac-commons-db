-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.region_polygon. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_region_polygon;
CREATE FUNCTION norpac_commons.u_region_polygon(
  IN p_id UUID, 
  IN p_id_region UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_region_polygon';
...
BEGIN
  ...
  UPDATE norpac_commons.region_polygon SET
    id_region = p_id_region, 
    sequence = p_sequence, 
    latitude = p_latitude, 
    longitude = p_longitude, 
