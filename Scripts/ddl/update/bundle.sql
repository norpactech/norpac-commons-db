-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.bundle. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_bundle;
CREATE FUNCTION norpac_commons.u_bundle(
  IN p_id UUID, 
...
BEGIN
  ...
  UPDATE norpac_commons.bundle SET
    id_rt_bundle_strategy = p_id_rt_bundle_strategy, 
    discount_percent = p_discount_percent, 
    metadata = p_metadata, 
    updated_by = p_updated_by, 
