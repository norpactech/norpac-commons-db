-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.pricing_tier. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_pricing_tier;
CREATE FUNCTION norpac_commons.u_pricing_tier(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_pricing_tier';
...
BEGIN
  ...
  UPDATE norpac_commons.pricing_tier SET
    id_pricing = p_id_pricing, 
    min_quantity = p_min_quantity, 
    max_quantity = p_max_quantity, 
    price_per_unit = p_price_per_unit, 
