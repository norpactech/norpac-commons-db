-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.subscription_plan. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_subscription_plan;
CREATE FUNCTION norpac_commons.u_subscription_plan(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_subscription_plan';
...
BEGIN
  ...
  UPDATE norpac_commons.subscription_plan SET
    id_product = p_id_product, 
    id_rt_billing_frequency = p_id_rt_billing_frequency, 
    id_rt_currency_code = p_id_rt_currency_code, 
    id_rt_renewal_policy = p_id_rt_renewal_policy, 
