-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.user_phone. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_user_phone;
CREATE FUNCTION norpac_commons.u_user_phone(
  IN p_id UUID, 
  IN p_id_user UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_user_phone';
...
BEGIN
  ...
  UPDATE norpac_commons.user_phone SET
    id_user = p_id_user, 
    id_rt_phone_type = p_id_rt_phone_type, 
    number = p_number, 
    extension = p_extension, 
