-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.pricing. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_pricing;
CREATE FUNCTION norpac_commons.u_pricing(
  IN p_id UUID, 
...
BEGIN
  ...
  UPDATE norpac_commons.pricing SET
    id_service_product = p_id_service_product, 
    id_rt_pricing_type = p_id_rt_pricing_type, 
    id_rt_billing_period = p_id_rt_billing_period, 
    id_rt_currency_code = p_id_rt_currency_code, 
