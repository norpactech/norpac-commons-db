-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.role. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_role;
CREATE FUNCTION norpac_commons.u_role(
  IN p_id UUID, 
  IN p_name VARCHAR, 
...
BEGIN
  ...
  UPDATE norpac_commons.role SET
    name = p_name, 
    description = p_description, 
    updated_by = p_updated_by, 
