-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.pricing_schedule_mapping. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_pricing_schedule_mapping;
CREATE FUNCTION norpac_commons.u_pricing_schedule_mapping(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_pricing_schedule_mapping';
...
BEGIN
  ...
  UPDATE norpac_commons.pricing_schedule_mapping SET
    id_pricing = p_id_pricing, 
    id_schedule_rule = p_id_schedule_rule, 
    effective_date = p_effective_date, 
    updated_by = p_updated_by, 
