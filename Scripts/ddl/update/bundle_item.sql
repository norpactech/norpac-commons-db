-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.bundle_item. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_bundle_item;
CREATE FUNCTION norpac_commons.u_bundle_item(
  IN p_id UUID, 
  IN p_id_bundle UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_bundle_item';
...
BEGIN
  ...
  UPDATE norpac_commons.bundle_item SET
    id_bundle = p_id_bundle, 
    id_child_product = p_id_child_product, 
    sequence = p_sequence, 
    quantity = p_quantity, 
