-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.user. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_user;
CREATE FUNCTION norpac_commons.u_user(
  IN p_id UUID, 
  IN p_email VARCHAR, 
...
BEGIN
  ...
  UPDATE norpac_commons.user SET
    email = p_email, 
    last_name = p_last_name, 
    first_name = p_first_name, 
    updated_by = p_updated_by, 
