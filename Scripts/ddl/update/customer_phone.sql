-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.customer_phone. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_customer_phone;
CREATE FUNCTION norpac_commons.u_customer_phone(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_customer_phone';
...
BEGIN
  ...
  UPDATE norpac_commons.customer_phone SET
    id_customer = p_id_customer, 
    id_rt_phone_type = p_id_rt_phone_type, 
    number = p_number, 
    extension = p_extension, 
