-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.tenant_origin. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_tenant_origin;
CREATE FUNCTION norpac_commons.u_tenant_origin(
  IN p_id UUID, 
  IN p_name VARCHAR, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_tenant_origin';
...
BEGIN
  ...
  UPDATE norpac_commons.tenant_origin SET
    name = p_name, 
    description = p_description, 
    updated_by = p_updated_by, 
