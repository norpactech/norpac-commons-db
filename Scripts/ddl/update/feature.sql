-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.feature. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_feature;
CREATE FUNCTION norpac_commons.u_feature(
  IN p_id UUID, 
  IN p_name VARCHAR, 
...
BEGIN
  ...
  UPDATE norpac_commons.feature SET
    name = p_name, 
    description = p_description, 
    is_addon = p_is_addon, 
    metadata = p_metadata, 
