-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.region. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_region;
CREATE FUNCTION norpac_commons.u_region(
  IN p_id UUID, 
  IN p_id_rt_region_type UUID, 
  IN p_name VARCHAR, 
...
BEGIN
  ...
  v_metadata := jsonb_build_object(
    'id', p_id, 
    'id_rt_region_type', p_id_rt_region_type, 
    'name', p_name, 
  ...
  UPDATE norpac_commons.region SET
    id_rt_region_type = p_id_rt_region_type, 
    name = p_name, 
    description = p_description, 
    updated_by = p_updated_by, 
