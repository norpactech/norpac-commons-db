-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.coupon_usage. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_coupon_usage;
CREATE FUNCTION norpac_commons.u_coupon_usage(
  IN p_id UUID, 
  IN p_id_coupon UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_coupon_usage';
...
BEGIN
  ...
  UPDATE norpac_commons.coupon_usage SET
    id_coupon = p_id_coupon, 
    id_customer = p_id_customer, 
    id_service_order = p_id_service_order, 
    used_at = p_used_at, 
