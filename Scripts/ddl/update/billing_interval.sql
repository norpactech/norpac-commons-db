-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.billing_interval. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_billing_interval;
CREATE FUNCTION norpac_commons.u_billing_interval(
  IN p_id UUID, 
  IN p_id_rt_interval_unit UUID, 
  IN p_name VARCHAR, 
  IN p_descritption TEXT, 
  IN p_interval_code VARCHAR, 
  IN p_interval_value INTEGER, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_billing_interval';
...
BEGIN
  ...
  v_metadata := jsonb_build_object(
    'id', p_id, 
    'id_rt_interval_unit', p_id_rt_interval_unit, 
    'name', p_name, 
    'descritption', p_descritption, 
    'interval_code', p_interval_code, 
  ...
  UPDATE norpac_commons.billing_interval SET
    id_rt_interval_unit = p_id_rt_interval_unit, 
    name = p_name, 
    descritption = p_descritption, 
    interval_code = p_interval_code, 
