-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.product_category. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_product_category;
CREATE FUNCTION norpac_commons.u_product_category(
  IN p_id UUID, 
  IN p_id_parent_category UUID, 
  IN p_code VARCHAR, 
  IN p_name VARCHAR, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_product_category';
...
BEGIN
  ...
  v_metadata := jsonb_build_object(
    'id', p_id, 
    'id_parent_category', p_id_parent_category, 
    'code', p_code, 
    'name', p_name, 
  ...
  UPDATE norpac_commons.product_category SET
    id_parent_category = p_id_parent_category, 
    code = p_code, 
    name = p_name, 
    description = p_description, 
