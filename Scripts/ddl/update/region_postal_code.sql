-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.region_postal_code. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_region_postal_code;
CREATE FUNCTION norpac_commons.u_region_postal_code(
  IN p_id UUID, 
  IN p_id_region UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_region_postal_code';
...
BEGIN
  ...
  UPDATE norpac_commons.region_postal_code SET
    id_region = p_id_region, 
    postal_code = p_postal_code, 
    updated_by = p_updated_by, 
