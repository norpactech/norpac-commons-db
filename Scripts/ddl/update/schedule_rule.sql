-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.schedule_rule. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_schedule_rule;
CREATE FUNCTION norpac_commons.u_schedule_rule(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_schedule_rule';
...
BEGIN
  ...
  UPDATE norpac_commons.schedule_rule SET
    id_product = p_id_product, 
    schedule_name = p_schedule_name, 
    start_date = p_start_date, 
    recurrence_rule = p_recurrence_rule, 
