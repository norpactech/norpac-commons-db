-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.rt_type. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_rt_type;
CREATE FUNCTION norpac_commons.u_rt_type(
  IN p_id UUID, 
  IN p_name VARCHAR, 
...
BEGIN
  ...
  UPDATE norpac_commons.rt_type SET
    name = p_name, 
    description = p_description, 
    updated_by = p_updated_by, 
