-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.product_feature_mapping. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_product_feature_mapping;
CREATE FUNCTION norpac_commons.u_product_feature_mapping(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_product_feature_mapping';
...
BEGIN
  ...
  UPDATE norpac_commons.product_feature_mapping SET
    id_product = p_id_product, 
    id_feature = p_id_feature, 
    included = p_included, 
    addon_price = p_addon_price, 
