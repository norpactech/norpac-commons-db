-- ---------------------------------------------------------------------------------------
-- Update: norpac_commons.coupon. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.u_coupon;
CREATE FUNCTION norpac_commons.u_coupon(
  IN p_id UUID, 
  IN p_id_rt_coupon_type UUID, 
  IN p_name VARCHAR, 
  IN p_code VARCHAR, 
  IN p_description TEXT, 
  IN p_amount DECIMAL, 
  IN p_max_uses INTEGER, 
  IN p_max_uses_per_customer INTEGER, 
...
BEGIN
  ...
  v_metadata := jsonb_build_object(
    'id', p_id, 
    'id_rt_coupon_type', p_id_rt_coupon_type, 
    'name', p_name, 
    'code', p_code, 
  ...
  UPDATE norpac_commons.coupon SET
    id_rt_coupon_type = p_id_rt_coupon_type, 
    name = p_name, 
    code = p_code, 
    description = p_description, 
