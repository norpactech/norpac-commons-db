...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_user;
CREATE FUNCTION norpac_commons.deact_user (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_user';
...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_user;
CREATE FUNCTION norpac_commons.react_user (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_user';
