-- -------------------------------------------------------
-- Deactivate tenant_origin (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_tenant_origin;
CREATE FUNCTION norpac_commons.deact_tenant_origin (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_tenant_origin';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate tenant_origin
  -- ------------------------------------------------------

 UPDATE norpac_commons.tenant_origin
    SET is_active = false 
    WHERE id = v_id
  ...
  ELSE
    ...
    SELECT count(*) INTO v_count   
      FROM norpac_commons.tenant_origin 
    WHERE id = v_id;
...
-- -------------------------------------------------------
-- Reactivate tenant_origin (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_tenant_origin;
CREATE FUNCTION norpac_commons.react_tenant_origin (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_tenant_origin';
