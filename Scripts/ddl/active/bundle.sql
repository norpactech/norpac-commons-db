...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_bundle;
CREATE FUNCTION norpac_commons.deact_bundle (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_bundle';
...
-- -------------------------------------------------------
-- Reactivate bundle (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_bundle;
CREATE FUNCTION norpac_commons.react_bundle (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_bundle';
