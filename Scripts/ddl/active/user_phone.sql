-- -------------------------------------------------------
-- Deactivate user_phone (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_user_phone;
CREATE FUNCTION norpac_commons.deact_user_phone (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_user_phone';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate user_phone
  -- ------------------------------------------------------

 UPDATE norpac_commons.user_phone
    SET is_active = false 
    WHERE id = v_id
  ...
  ELSE
    ...
    SELECT count(*) INTO v_count   
      FROM norpac_commons.user_phone 
    WHERE id = v_id;
...
-- -------------------------------------------------------
-- Reactivate user_phone (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_user_phone;
CREATE FUNCTION norpac_commons.react_user_phone (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_user_phone';
