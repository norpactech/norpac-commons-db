-- -------------------------------------------------------
-- Deactivate billing_interval (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_billing_interval;
CREATE FUNCTION norpac_commons.deact_billing_interval (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_billing_interval';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate billing_interval
  -- ------------------------------------------------------

 UPDATE norpac_commons.billing_interval
    SET is_active = false 
    WHERE id = v_id
  ...
  ELSE
    ...
    SELECT count(*) INTO v_count   
      FROM norpac_commons.billing_interval 
    WHERE id = v_id;
...
-- -------------------------------------------------------
-- Reactivate billing_interval (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_billing_interval;
CREATE FUNCTION norpac_commons.react_billing_interval (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_billing_interval';
