-- -------------------------------------------------------
-- Deactivate feature (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_feature;
CREATE FUNCTION norpac_commons.deact_feature (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_feature';
...
-- -------------------------------------------------------
-- Reactivate feature (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_feature;
CREATE FUNCTION norpac_commons.react_feature (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_feature';
