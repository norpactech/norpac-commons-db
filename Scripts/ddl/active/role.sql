...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_role;
CREATE FUNCTION norpac_commons.deact_role (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_role';
...
-- -------------------------------------------------------
-- Reactivate role (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_role;
CREATE FUNCTION norpac_commons.react_role (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_role';
