...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_coupon;
CREATE FUNCTION norpac_commons.deact_coupon (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_coupon';
...
-- -------------------------------------------------------
-- Reactivate coupon (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_coupon;
CREATE FUNCTION norpac_commons.react_coupon (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_coupon';
