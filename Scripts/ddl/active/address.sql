...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_address;
CREATE FUNCTION norpac_commons.deact_address (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_address';
...
-- -------------------------------------------------------
-- Reactivate address (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_address;
CREATE FUNCTION norpac_commons.react_address (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_address';
