-- -------------------------------------------------------
-- Deactivate customer_phone (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_customer_phone;
CREATE FUNCTION norpac_commons.deact_customer_phone (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_customer_phone';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate customer_phone
  -- ------------------------------------------------------

 UPDATE norpac_commons.customer_phone
    SET is_active = false 
    WHERE id = v_id
  ...
  ELSE
    ...
    SELECT count(*) INTO v_count   
      FROM norpac_commons.customer_phone 
    WHERE id = v_id;
...
-- -------------------------------------------------------
-- Reactivate customer_phone (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_customer_phone;
CREATE FUNCTION norpac_commons.react_customer_phone (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_customer_phone';
