-- -------------------------------------------------------
-- Deactivate region_polygon (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_region_polygon;
CREATE FUNCTION norpac_commons.deact_region_polygon (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_region_polygon';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate region_polygon
  -- ------------------------------------------------------

 UPDATE norpac_commons.region_polygon
    SET is_active = false 
    WHERE id = v_id
  ...
  ELSE
    ...
    SELECT count(*) INTO v_count   
      FROM norpac_commons.region_polygon 
    WHERE id = v_id;
...
-- -------------------------------------------------------
-- Reactivate region_polygon (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_region_polygon;
CREATE FUNCTION norpac_commons.react_region_polygon (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_region_polygon';
