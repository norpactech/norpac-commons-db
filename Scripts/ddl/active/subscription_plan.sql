-- -------------------------------------------------------
-- Deactivate subscription_plan (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_subscription_plan;
CREATE FUNCTION norpac_commons.deact_subscription_plan (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_subscription_plan';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate subscription_plan
  -- ------------------------------------------------------

 UPDATE norpac_commons.subscription_plan
    SET is_active = false 
    WHERE id = v_id
...
-- -------------------------------------------------------
-- Reactivate subscription_plan (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_subscription_plan;
CREATE FUNCTION norpac_commons.react_subscription_plan (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_subscription_plan';
