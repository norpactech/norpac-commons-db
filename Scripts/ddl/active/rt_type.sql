-- -------------------------------------------------------
-- Deactivate rt_type (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_rt_type;
CREATE FUNCTION norpac_commons.deact_rt_type (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_rt_type';
...
-- -------------------------------------------------------
-- Reactivate rt_type (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_rt_type;
CREATE FUNCTION norpac_commons.react_rt_type (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_rt_type';
