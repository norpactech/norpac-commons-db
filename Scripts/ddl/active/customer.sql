...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_customer;
CREATE FUNCTION norpac_commons.deact_customer (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_customer';
...
BEGIN
 ...
 UPDATE norpac_commons.customer
    SET is_active = false 
    WHERE id = v_id
...
-- -------------------------------------------------------
-- Reactivate customer (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_customer;
CREATE FUNCTION norpac_commons.react_customer (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_customer';
