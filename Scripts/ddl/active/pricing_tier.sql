-- -------------------------------------------------------
-- Deactivate pricing_tier (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_pricing_tier;
CREATE FUNCTION norpac_commons.deact_pricing_tier (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_pricing_tier';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate pricing_tier
  -- ------------------------------------------------------

 UPDATE norpac_commons.pricing_tier
    SET is_active = false 
    WHERE id = v_id
...
-- -------------------------------------------------------
-- Reactivate pricing_tier (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_pricing_tier;
CREATE FUNCTION norpac_commons.react_pricing_tier (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_pricing_tier';
