...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_region;
CREATE FUNCTION norpac_commons.deact_region (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_region';
...
-- -------------------------------------------------------
-- Reactivate region (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_region;
CREATE FUNCTION norpac_commons.react_region (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_region';
