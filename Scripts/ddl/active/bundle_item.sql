-- -------------------------------------------------------
-- Deactivate bundle_item (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_bundle_item;
CREATE FUNCTION norpac_commons.deact_bundle_item (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_bundle_item';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate bundle_item
  -- ------------------------------------------------------

 UPDATE norpac_commons.bundle_item
    SET is_active = false 
    WHERE id = v_id
...
-- -------------------------------------------------------
-- Reactivate bundle_item (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_bundle_item;
CREATE FUNCTION norpac_commons.react_bundle_item (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_bundle_item';
