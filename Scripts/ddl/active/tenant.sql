...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_tenant;
CREATE FUNCTION norpac_commons.deact_tenant (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_tenant';
...
-- -------------------------------------------------------
-- Reactivate tenant (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_tenant;
CREATE FUNCTION norpac_commons.react_tenant (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_tenant';
