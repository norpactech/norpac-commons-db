-- -------------------------------------------------------
-- Deactivate product_feature_mapping (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_product_feature_mapping;
CREATE FUNCTION norpac_commons.deact_product_feature_mapping (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_product_feature_mapping';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate product_feature_mapping
  -- ------------------------------------------------------

 UPDATE norpac_commons.product_feature_mapping
    SET is_active = false 
    WHERE id = v_id
...
-- -------------------------------------------------------
-- Reactivate product_feature_mapping (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_product_feature_mapping;
CREATE FUNCTION norpac_commons.react_product_feature_mapping (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_product_feature_mapping';
