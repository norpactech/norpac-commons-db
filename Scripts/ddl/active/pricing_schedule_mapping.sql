-- -------------------------------------------------------
-- Deactivate pricing_schedule_mapping (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_pricing_schedule_mapping;
CREATE FUNCTION norpac_commons.deact_pricing_schedule_mapping (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_pricing_schedule_mapping';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate pricing_schedule_mapping
  -- ------------------------------------------------------

 UPDATE norpac_commons.pricing_schedule_mapping
    SET is_active = false 
    WHERE id = v_id
  ...
  IF v_updates > 0 THEN
    ...
    CALL norpac_commons.i_logs('INFO', v_response.message, c_service_name, p_updated_by, v_metadata);    
  ELSE
...
-- -------------------------------------------------------
-- Reactivate pricing_schedule_mapping (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_pricing_schedule_mapping;
CREATE FUNCTION norpac_commons.react_pricing_schedule_mapping (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_pricing_schedule_mapping';
