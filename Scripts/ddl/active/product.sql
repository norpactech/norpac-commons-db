...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_product;
CREATE FUNCTION norpac_commons.deact_product (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_product';
...
-- -------------------------------------------------------
-- Reactivate product (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_product;
CREATE FUNCTION norpac_commons.react_product (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_product';
