-- -------------------------------------------------------
-- Deactivate service_order (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_service_order;
CREATE FUNCTION norpac_commons.deact_service_order (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_service_order';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate service_order
  -- ------------------------------------------------------

 UPDATE norpac_commons.service_order
    SET is_active = false 
    WHERE id = v_id
...
-- -------------------------------------------------------
-- Reactivate service_order (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_service_order;
CREATE FUNCTION norpac_commons.react_service_order (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_service_order';
