-- -------------------------------------------------------
-- Deactivate schedule_rule (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_schedule_rule;
CREATE FUNCTION norpac_commons.deact_schedule_rule (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_schedule_rule';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate schedule_rule
  -- ------------------------------------------------------

 UPDATE norpac_commons.schedule_rule
    SET is_active = false 
    WHERE id = v_id
...
-- -------------------------------------------------------
-- Reactivate schedule_rule (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_schedule_rule;
CREATE FUNCTION norpac_commons.react_schedule_rule (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_schedule_rule';
