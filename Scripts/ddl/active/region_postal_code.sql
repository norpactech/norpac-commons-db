-- -------------------------------------------------------
-- Deactivate region_postal_code (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_region_postal_code;
CREATE FUNCTION norpac_commons.deact_region_postal_code (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_region_postal_code';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate region_postal_code
  -- ------------------------------------------------------

 UPDATE norpac_commons.region_postal_code
    SET is_active = false 
    WHERE id = v_id
  ...
  ELSE
    ...
    SELECT count(*) INTO v_count   
      FROM norpac_commons.region_postal_code 
    WHERE id = v_id;
...
-- -------------------------------------------------------
-- Reactivate region_postal_code (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_region_postal_code;
CREATE FUNCTION norpac_commons.react_region_postal_code (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_region_postal_code';
