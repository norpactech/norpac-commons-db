-- -------------------------------------------------------
-- Deactivate rt_values (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_rt_values;
CREATE FUNCTION norpac_commons.deact_rt_values (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_rt_values';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate rt_values
  -- ------------------------------------------------------

 UPDATE norpac_commons.rt_values
    SET is_active = false 
    WHERE id = v_id
...
-- -------------------------------------------------------
-- Reactivate rt_values (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_rt_values;
CREATE FUNCTION norpac_commons.react_rt_values (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_rt_values';
