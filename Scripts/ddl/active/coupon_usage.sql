-- -------------------------------------------------------
-- Deactivate coupon_usage (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_coupon_usage;
CREATE FUNCTION norpac_commons.deact_coupon_usage (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_coupon_usage';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate coupon_usage
  -- ------------------------------------------------------

 UPDATE norpac_commons.coupon_usage
    SET is_active = false 
    WHERE id = v_id
...
-- -------------------------------------------------------
-- Reactivate coupon_usage (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_coupon_usage;
CREATE FUNCTION norpac_commons.react_coupon_usage (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_coupon_usage';
