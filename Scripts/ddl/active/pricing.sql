...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.deact_pricing;
CREATE FUNCTION norpac_commons.deact_pricing (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_pricing';
...
-- -------------------------------------------------------
-- Reactivate pricing (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.react_pricing;
CREATE FUNCTION norpac_commons.react_pricing (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_pricing';
