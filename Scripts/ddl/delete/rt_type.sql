...
-- Delete rt_type
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_rt_type;
CREATE FUNCTION norpac_commons.d_rt_type(
  IN p_id UUID, 
...
BEGIN
  ...
  DELETE FROM norpac_commons.rt_type 
    WHERE id = v_id
