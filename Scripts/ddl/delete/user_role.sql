...
-- Delete user_role
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_user_role;
CREATE FUNCTION norpac_commons.d_user_role(
  IN p_id_user UUID, 
  IN p_id_role UUID
)
...
DECLARE
  ...
  c_service_name TEXT := 'd_user_role';
...
BEGIN
  ...
  DELETE FROM norpac_commons.user_role 
    WHERE id_user = v_id_user
      AND id_role = v_id_role
  ;
