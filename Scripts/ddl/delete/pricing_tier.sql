...
-- Delete pricing_tier
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_pricing_tier;
CREATE FUNCTION norpac_commons.d_pricing_tier(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_pricing_tier';
...
BEGIN
  ...
  DELETE FROM norpac_commons.pricing_tier 
    WHERE id = v_id
