...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_subscription_plan;
CREATE FUNCTION norpac_commons.d_subscription_plan(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_subscription_plan';
...
BEGIN
  ...
  DELETE FROM norpac_commons.subscription_plan 
    WHERE id = v_id
