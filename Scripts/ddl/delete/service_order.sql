...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_service_order;
CREATE FUNCTION norpac_commons.d_service_order(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_service_order';
...
BEGIN
  ...
  DELETE FROM norpac_commons.service_order 
    WHERE id = v_id
