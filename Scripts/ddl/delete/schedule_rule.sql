-- -------------------------------------------------------
-- Delete schedule_rule
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_schedule_rule;
CREATE FUNCTION norpac_commons.d_schedule_rule(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_schedule_rule';
...
BEGIN
  ...
  DELETE FROM norpac_commons.schedule_rule 
    WHERE id = v_id
