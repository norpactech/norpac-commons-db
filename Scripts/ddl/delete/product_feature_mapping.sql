-- -------------------------------------------------------
-- Delete product_feature_mapping
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_product_feature_mapping;
CREATE FUNCTION norpac_commons.d_product_feature_mapping(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_product_feature_mapping';
...
BEGIN
  ...
  DELETE FROM norpac_commons.product_feature_mapping 
    WHERE id = v_id
