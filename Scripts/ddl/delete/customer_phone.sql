...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_customer_phone;
CREATE FUNCTION norpac_commons.d_customer_phone(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_customer_phone';
...
BEGIN
  ...
  DELETE FROM norpac_commons.customer_phone 
    WHERE id = v_id
