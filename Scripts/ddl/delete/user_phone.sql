...
-- Delete user_phone
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_user_phone;
CREATE FUNCTION norpac_commons.d_user_phone(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_user_phone';
...
BEGIN
  ...
  DELETE FROM norpac_commons.user_phone 
    WHERE id = v_id
