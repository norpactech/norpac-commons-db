...
-- Delete coupon_usage
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_coupon_usage;
CREATE FUNCTION norpac_commons.d_coupon_usage(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_coupon_usage';
...
BEGIN
  ...
  DELETE FROM norpac_commons.coupon_usage 
    WHERE id = v_id
