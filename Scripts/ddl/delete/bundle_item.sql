...
-- Delete bundle_item
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_bundle_item;
CREATE FUNCTION norpac_commons.d_bundle_item(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_bundle_item';
...
BEGIN
  ...
  DELETE FROM norpac_commons.bundle_item 
    WHERE id = v_id
