...
-- Delete pricing
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_pricing;
CREATE FUNCTION norpac_commons.d_pricing(
  IN p_id UUID, 
...
BEGIN
  ...
  DELETE FROM norpac_commons.pricing 
    WHERE id = v_id
