...
-- Delete product
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_product;
CREATE FUNCTION norpac_commons.d_product(
  IN p_id UUID, 
...
BEGIN
  ...
  DELETE FROM norpac_commons.product 
    WHERE id = v_id
