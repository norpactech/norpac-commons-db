-- -------------------------------------------------------
-- Delete pricing_schedule_mapping
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_pricing_schedule_mapping;
CREATE FUNCTION norpac_commons.d_pricing_schedule_mapping(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_pricing_schedule_mapping';
...
BEGIN
  ...
  DELETE FROM norpac_commons.pricing_schedule_mapping 
    WHERE id = v_id
