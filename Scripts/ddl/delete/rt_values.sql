...
-- Delete rt_values
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_rt_values;
CREATE FUNCTION norpac_commons.d_rt_values(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_rt_values';
...
BEGIN
  ...
  DELETE FROM norpac_commons.rt_values 
    WHERE id = v_id
