-- -------------------------------------------------------
-- Delete tenant_origin
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_tenant_origin;
CREATE FUNCTION norpac_commons.d_tenant_origin(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_tenant_origin';
...
BEGIN
  ...
  DELETE FROM norpac_commons.tenant_origin 
    WHERE id = v_id
