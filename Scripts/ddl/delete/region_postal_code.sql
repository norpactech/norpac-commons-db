-- -------------------------------------------------------
-- Delete region_postal_code
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_region_postal_code;
CREATE FUNCTION norpac_commons.d_region_postal_code(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_region_postal_code';
...
BEGIN
  ...
  DELETE FROM norpac_commons.region_postal_code 
    WHERE id = v_id
