-- -------------------------------------------------------
-- Delete billing_interval
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_billing_interval;
CREATE FUNCTION norpac_commons.d_billing_interval(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_billing_interval';
...
BEGIN
  ...
  DELETE FROM norpac_commons.billing_interval 
    WHERE id = v_id
