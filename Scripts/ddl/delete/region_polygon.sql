-- -------------------------------------------------------
-- Delete region_polygon
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_region_polygon;
CREATE FUNCTION norpac_commons.d_region_polygon(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_region_polygon';
...
BEGIN
  ...
  DELETE FROM norpac_commons.region_polygon 
    WHERE id = v_id
