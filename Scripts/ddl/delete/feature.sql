...
-- Delete feature
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_feature;
CREATE FUNCTION norpac_commons.d_feature(
  IN p_id UUID, 
...
BEGIN
  ...
  DELETE FROM norpac_commons.feature 
    WHERE id = v_id
