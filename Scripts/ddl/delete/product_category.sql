...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_product_category;
CREATE FUNCTION norpac_commons.d_product_category(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_product_category';
...
BEGIN
  ...
  DELETE FROM norpac_commons.product_category 
    WHERE id = v_id
