...
-- Delete address
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_address;
CREATE FUNCTION norpac_commons.d_address(
  IN p_id UUID, 
...
BEGIN
  ...
  DELETE FROM norpac_commons.address 
    WHERE id = v_id
