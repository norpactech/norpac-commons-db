...
-- Delete customer
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS norpac_commons.d_customer;
CREATE FUNCTION norpac_commons.d_customer(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_customer';
...
BEGIN
  ...
  DELETE FROM norpac_commons.customer 
    WHERE id = v_id
